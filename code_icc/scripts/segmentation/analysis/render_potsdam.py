...
# export CUDA_VISIBLE_DEVICES=3 && nohup python -m code_icc.scripts.segmentation.analysis.render_potsdam --model_ind 738 --net_name best.pytorch > out/gnodec4_render_738.out &
