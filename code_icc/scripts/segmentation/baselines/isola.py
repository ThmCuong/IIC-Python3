...
from code_icc.utils.cluster.general import config_to_str, get_opt, update_lr
from code_icc.utils.cluster.transforms import sobel_process
from code_icc.utils.segmentation.data import make_Coco_dataloaders, \
  make_Potsdam_dataloaders
from code_icc.utils.segmentation.baselines.kmeans_segmentation_eval import \
  kmeans_segmentation_eval
from code_icc.utils.segmentation.baselines.isola_utils import isola_loss, \
  isola_set_patches
...
parser.add_argument("--fine_to_coarse_dict", type=str,
                    default="/users/xuji/iid/iid_private/code_icc/datasets"
