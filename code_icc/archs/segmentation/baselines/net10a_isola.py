...
from code_icc.archs.cluster.vgg import VGGNet
from code_icc.archs.segmentation.net10a import SegmentationNet10aTrunk, \
  SegmentationNet10a
from code_icc.utils.segmentation.baselines.general import get_patches
